...
Adapted from Kintsugi's EFE module with marketing-specific weight
profiles for Apolaki's 10 skill domains.
"""
...
# Marketing-specific weight profiles -- one per Apolaki skill domain.
WEB_DESIGN_WEIGHTS = EFEWeights(risk=0.3, ambiguity=0.3, epistemic=0.4)
SOCIAL_MEDIA_WEIGHTS = EFEWeights(risk=0.3, ambiguity=0.3, epistemic=0.4)
CONTENT_CREATION_WEIGHTS = EFEWeights(risk=0.4, ambiguity=0.2, epistemic=0.4)
LEAD_GENERATION_WEIGHTS = EFEWeights(risk=0.4, ambiguity=0.3, epistemic=0.3)
PARTNERSHIPS_WEIGHTS = EFEWeights(risk=0.3, ambiguity=0.4, epistemic=0.3)
MEDIA_RELATIONS_WEIGHTS = EFEWeights(risk=0.5, ambiguity=0.2, epistemic=0.3)  # Higher risk - public facing
FUNDRAISING_WEIGHTS = EFEWeights(risk=0.4, ambiguity=0.3, epistemic=0.3)
BRAND_STRATEGY_WEIGHTS = EFEWeights(risk=0.3, ambiguity=0.3, epistemic=0.4)
ANALYTICS_WEIGHTS = EFEWeights(risk=0.2, ambiguity=0.3, epistemic=0.5)  # Highest epistemic - data driven
COMMUNITY_WEIGHTS = EFEWeights(risk=0.3, ambiguity=0.3, epistemic=0.4)
